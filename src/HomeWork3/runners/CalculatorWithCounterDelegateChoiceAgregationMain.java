...
public class CalculatorWithCounterDelegateChoiceAgregationMain {
    public static void main(String[] args) {
        ...
        double a1 = calculator1.division(28.0, 5);
        double b1 = calculator1.multiplication(15, 7);
        double c1 = calculator1.raiseToPower(a1, 2);
        ...
        double b2 = calculator2.multiplication(15, 7);
        double c2 = calculator2.raiseToPower(a2, 2);
        ...
        double b3 = calculator2.multiplication(15, 7);
        double c3 = calculator2.raiseToPower(a3, 2);
